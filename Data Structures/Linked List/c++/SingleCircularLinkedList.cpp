...
{
    puts("\nCurrently the Circular Linked List is as follows...");
    node* temp=(*header);
    cout<<temp->data<<"->";
    temp=temp->next;
    while(temp!=(*header))
...
void InsertLL(node** header)
{
    ...
    if((*header)->next==(*header) and choice!=1)
    {
        puts("\nCircular Linked List is Empty");
        puts("Therfore inserting at front");
        choice=1;
    }
    switch(choice)
    {
        ...
        case 1:
            {
                ...
                cout<<endl<<temp->data<<" deleted from Circular Linked List\n";
                free(temp);
                break;
            }
        case 2:
            {
                ...
                cout<<endl<<traverse->data<<" deleted from Circular Linked List\n";
                free(traverse);
                prev_traverse->next=(*header);
                break;
            }
        case 3:
            {
...
int main()
{
    ...
    header->next=header;
    header->data='H';
    puts("######## Welcome to Single Circular Linked List ########");
    Repeat:
    PrintLL(&header);
